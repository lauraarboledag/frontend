...
import { getTipoEquipos,createTipoEquipo, editarTipoEquipo, eliminarTipoEquipo, getTipos} from "../services/inventario"
...
export default function Inventario() {
    ...
    const listarEquipos1 = async () => {
        const { data } = await getTipos("usuario",true)
    ...
    const listarEquipos2 = async () => {
        const { data } = await getTipos("marca", true)
        const daticos = data.map(datico => datico.estado === true ? datico : null)
        console.log(daticos)
        setMarcas(daticos)
    }
    ...
    const listarEquipos3 = async () => {
        const { data } = await getTipos("estadoequipo", true)
        const daticos = data.map(datico => datico.estado === true ? datico : null)
        console.log(daticos)
        setEstados(daticos)
    }
    ...
    const listarEquipos4 = async () => {
        const { data } = await getTipos("tipoequipo", true)
        const daticos = data.map(datico => datico.estado === true ? datico : null)
        console.log(daticos)
        setEquipos1(daticos)
    }
                                ...
                                <form onSubmit={handleSubmit} className="row g-3">
                                    ...
                                    <div className="col-auto" style={{ marginRight: "60px", marginTop: "40px", width: "30%" }}>
                                        ...
                                        <input
                                            ...
                                            onChange={event => setNewEquipo({
                                                modelo: event.target.value, serial: newEquipo.serial,
                                                descrip: newEquipo.descrip, foto: newEquipo.foto, color: newEquipo.color,
                                                fechaCompra: newEquipo.fechaCompra, precio: newEquipo.precio, usuario: newEquipo.usuario,
                                                marca: newEquipo.marca, estado: newEquipo.estado, equipo: newEquipo.equipo
                                            })}
                                    ...
                                    <div className="col-auto" style={{ marginRight: "60px", marginTop: "40px", width: "30%" }}>
                                        ...
                                        <input
                                            ...
                                            onChange={event => isNaN(event.target.value) ? handleKeyPress : setNewEquipo({
                                ...
                                <form onSubmit={editarEquipos} className="row g-3">
                                    <div className="col-auto" style={{ marginRight: "60px", marginTop: "40px", width: "30%" }}>
                                        ...
                                        <input
                                            ...
                                            onChange={event => setNewEditarEquipo({
                                                ...
                                                descripcion: newEditarEquipo.descripcion === "" ? equipoRecuperado.descripcion : newEditarEquipo.descripcion,
                                    ...
                                    <div className="col-auto" style={{ marginRight: "60px", marginTop: "40px", width: "30%" }}>
                                        ...
                                        >
                                            <option value="">Selecciona el usuario...</option>
                                            {usuarios != null ? usuarios.map((equipo, index) => equipo != null ? (
                                                <option key={index} value={equipo._id} name={equipo._id}>
                                                    {equipo.nombre}
                                                </option>
                                            ) : null) : nada}
                            ...
                            equipos1 != null ? equipos1.map((tipoequipos, index) => {
                                return (
                                    <tr key={tipoequipos.id}>
                                        ...
                                        <td><img style={{width: "50px"}} src={tipoequipos.foto}></img></td>
                                        <td>{tipoequipos.color}</td>
                                        <td>{tipoequipos.fechaCompra}</td>
                                        <td>{tipoequipos.precio}</td>
                                        <td>{tipoequipos.usuario.nombre}</td>
                                        <td>{tipoequipos.marca.nombre}</td>
                                        <td>{tipoequipos.estado.nombre}</td>
                                        <td>{tipoequipos.tipoEquipo.nombre}</td>
                                        <td><button type="button" className="btn btn-success"
                                            data-bs-toggle="modal"
                                            data-bs-target="#exampleModal15"
                                            data-bs-whatever="@mdo"
                                            id={tipoequipos._id}
                                            value={tipoequipos._id}
                                            data-serial={tipoequipos.serial}
                                            data-modelo={tipoequipos.modelo}
                                            data-descrip={tipoequipos.descripcion}
                                            ...
                                            data-usuario={tipoequipos.usuario._id}
                                            data-marca={tipoequipos.marca._id}
                                            data-estado={tipoequipos.estado._id}
                                            data-equipo={tipoequipos.tipoEquipo._id}
